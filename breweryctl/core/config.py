...
class Settings:
    ...
    yeast_viability_min_pct: float = 90.0
    log_level: str = "INFO"
    ...
    def validate(self) -> "Settings":
        ...
        require_int(self.yeast_max_generation, field="yeast_max_generation", minimum=0, maximum=30)
        require_number(
            self.yeast_viability_min_pct,
            field="yeast_viability_min_pct",
            minimum=1.0,
            maximum=100.0,
        )
    ...
    def describe(self) -> dict[str, Any]:
        ...
        return {
            ...
            "yeast_viability_min_pct": self.yeast_viability_min_pct,
